...
export default ({ childProps }) => (
  <Switch>
    <Route exact path="/" component={AsyncLanding} props={childProps} />
    <Route exact path="/discover" component={AsyncDiscover} props={childProps} />
    <Route exact path="/project/:readableUrl" component={AsyncProject} props={childProps} />
    <Route exact path="/about" component={AsyncAbout} props={childProps} />
    <Route exact path="/team" component={AsyncTeam} props={childProps} />
    <Route exact path="/blog" component={AsyncBlog} props={childProps} />
    <Route exact path="/post/:id" component={AsyncPost} props={childProps} />
    <UnauthenticatedRoute exact path="/login" component={AsyncLogin} props={childProps} />
    ...
    <AuthenticatedRoute
      ...
      props={childProps}
    />
    <AuthenticatedRoute exact path="/payment" component={AsyncPayment} props={childProps} />
