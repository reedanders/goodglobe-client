...
const cards = [
  {
    title: 'Create',
    description:
      'Practitioners submit an environmental conservation project for review by scientists',
          ...
          <Grid container item key={card.title} xs={12} sm={6} md={4} alignItems="center">
            <Card elevation={0} className={classes.card}>
              <Grid container alignItems="center" justify="center">
                <Grid item></Grid>
                <Grid item>
                  <LazyLoad height={160} width={160}>
                    <img src={card.image} alt={card.title} className={classes.cardMedia} />
                  </LazyLoad>
                </Grid>
                <Grid item></Grid>
              </Grid>
