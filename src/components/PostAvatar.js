  ...
  return (
    <div className={classes.root}>
        <Grid container direction="row" alignItems="center" spacing={1}>
          ...
          <Grid item>
            <Avatar className={classes.practionerImage} alt={fetchedPost.author} src={fetchedPost.thumbnail} />
          </Grid>
          ...
          <Grid item>
            <Grid container direction="column" className={classes.summary}>
              ...
              <Grid item><Typography variant="caption" component="p">Team Post</Typography></Grid>
            </Grid>
          </Grid>
        </Grid>
