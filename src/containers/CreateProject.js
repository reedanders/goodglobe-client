      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} onSubmit={handleSubmit} noValidate>
          ...
          <Typography variant="caption" className={classes.objectivesHelper}>
            Edit objectives needed to complete your project
          </Typography>
          ...
          <FormControl component="fieldset">
            ...
            <FormGroup className={classes.formGroup}>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={fields.theme_resilience}
                    onChange={handleFieldChange}
                    id="theme_resilience"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={fields.theme_mitigation}
                    onChange={handleFieldChange}
                    id="theme_mitigation"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={fields.theme_awareness}
                    onChange={handleFieldChange}
                    id="theme_awareness"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={fields.theme_knowledge}
                    onChange={handleFieldChange}
                    id="theme_knowledge"
